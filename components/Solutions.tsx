...
export default function Solutions() {
  return (
    <section className="relative py-24 bg-[#131126] text-white overflow-hidden select-none">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10 flex flex-col">

        {/* Row 1: Heading with Hanging Indent */}
        <div className="flex items-center mb-[80px] lg:mb-[100px] w-full">
          {/* Hanging Prefix Column */}
          <div className="w-[120px] lg:w-[160px] flex items-center shrink-0">
            <span className="font-sans font-black text-[20px] lg:text-[24px] leading-none tracking-tight">02.</span>
          ...
          <div className="flex items-baseline">
            <h2 className="font-bold text-[20px] lg:text-[24px] leading-none font-sans capitalize tracking-tight text-white">
              We Build Smarter, Faster Solution
            </h2>
        ...
        <div className="w-full pl-0 md:pl-[120px] lg:pl-[160px]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-28 self-start space-y-8 text-left">
